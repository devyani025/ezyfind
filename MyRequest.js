       ...
       <ScrollView>
            <View style={{backgroundColor:"white"}}>
                    <View style={styles.SectionStyle}>
                     ...
                     <TouchableOpacity  onPress={() => { navigation.navigate('Request25')}}
                     activeOpacity={0.9}> 
                  ...
                  <Image style={styles.image} source={require('../assets/R25.png')}/>
                    ...
                    <View> 
                      ...
                      <View style={{ flex: 1, flexDirection: 'row', paddingTop: 5, paddingBottom: 20}}>
                       ...
                       <Text style={{marginLeft:110, bottom:65, color:"#323232", fontSize:11}}>1Get the best service from us</Text>
                    </View>  
                    <Image style={{ width: 15, height: 15, marginRight:15,bottom:105, alignSelf:"flex-end" }} source={require('../assets/Pat111.png')} />
               </View>
               </TouchableOpacity>
